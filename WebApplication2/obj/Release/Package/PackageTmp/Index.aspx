    ...
    <section id="contact-us" class="section section-bgimage-yes">
        <div class="section-inner">
            ...
            <div class="container section-content">
                ...
                <div class="row">
                    <form name="contact-us-form" id="contact-us-form" class="element-line contact-us-form" role="form">
                        <div class="col-md-5 col-md-offset-1">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <asp:TextBox ID="nameTbx" CssClass="form-control" runat="server" />
                                </div>
                                <!-- //.input-group -->
                            </div>
                            <!-- //.form-group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-lg">
                                    <%--<input type="email" name="email" id="email" class="form-control required email" placeholder="Введите email">--%>
                                    <asp:TextBox ID="emailTbx" CssClass="form-control" runat="server"/>
                                </div>
                                <!-- //.input-group -->
                            </div>
                            <!-- //.form-group -->
                            ...
                            <div class="form-group form-group-bottom">
                                ...
                                <div class="input-group input-group-lg">
                                    <%--<input type="text" name="subject" id="subject" class="form-control required" placeholder="Введите имя компании">--%>
                                    <asp:TextBox ID="companyTbx" CssClass="form-control" runat="server" />
                                </div>
                                <!-- //.input-group -->
                            </div>
                            <!-- //.form-group -->
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-lg">
                                    <%--<textarea name="message" id="message" class="form-control required" placeholder="Введите сообщение"></textarea>--%>
                                    <asp:TextBox ID="messageTbx" CssClass="form-control" runat="server" TextMode="MultiLine" />
                                </div>
                                <!-- //.input-group -->
                            </div>
                            <!-- //.form-group -->
                            ...
                            <div class="form-group form-group-bottom">
                                <%--<button id="submit" type="submit" class="btn btn-lg btn-rj">Оформить заказ </button>--%>
                                <asp:Button ID="submitBtn" CssClass="btn btn-lg btn-rj" runat="server" Text="Оформить заказ" OnClick="submitBtn_Click" />
